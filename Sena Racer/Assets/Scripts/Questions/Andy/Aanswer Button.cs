...
public class AanswerButton : MonoBehaviour
{
    ...
    QuestionData[] GetRandomQuestions()
    {
        ...
        {
            new QuestionData("¿Cúal es el nombre de nuestra institución?", new string[] { "Servicio Nacional de Aprendizaje", "Servicio de Negocios de Aprendizaje", "Sistema Nacional de Aprendizaje", "Servicio Internacional de Aprendizaje" }, "Servicio Nacional de Aprendizaje"),
