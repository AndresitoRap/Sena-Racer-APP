...
public class AnswerButton : MonoBehaviour
{
    ...
    private Dictionary<string, QuestionDataMao[]> sceneQuestions = new Dictionary<string, QuestionDataMao[]>
    {
        ...
        {
            "MQuestion", new QuestionDataMao[]
            {
                new QuestionDataMao("¿Cuál de las siguientes afirmaciones sobre los porcinos es verdadera?", new string[] { "Los porcinos son animales herbívoros.", "Los porcinos fueron domesticados por primera vez en América", "Los porcinos no pueden consumir frutas.", "Los porcinos fueron domesticados hace unos 13,000 años en china" }, "Los porcinos fueron domesticados hace unos 13,000 años en china"),
